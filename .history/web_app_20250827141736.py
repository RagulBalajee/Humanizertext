  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      /* Make form compact so only the textarea looks like a single box */
      .form-shell { width: 100%; max-width: 520px; }
      .panel.form-shell { max-width: 520px; margin: 0 auto; }
      .square-wrap { width: 100%; max-width: 440px; aspect-ratio: 1 / 1; margin: 0 auto; }
