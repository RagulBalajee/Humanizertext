  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      /* Slightly larger square input */
      .form-shell { width: 100%; max-width: 560px; }
      .panel.form-shell { max-width: 560px; margin: 0 auto; }
      .square-wrap { width: 100%; max-width: 520px; aspect-ratio: 1 / 1; margin: 0 auto; }
      ...
      .footer { margin-top: 20px; color: var(--muted); font-size: 11px; text-align: center; letter-spacing: .4px; }
    </style>
  </head>
  <body>
    <div class="container">
      ...
      {% if result %}
      <div class="panel" style="max-width:960px; margin:18px auto 0;">
      ...
      <div class="footer">Ragul Balajee</div>
    </div>
